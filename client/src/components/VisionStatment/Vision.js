  ...
  return (
    ...
    <div>
      <div className="row" id="visionRow">
        <div className="col s12 m6 center" id="vision">
          <h3>
          ...
          <p className="left-align light">
            <strong>
              ...
              chatroom for custom groups, Create as many as you'd like or join
              as many as you want! Now, you can coordinate long distance
              conversations, organize your group chats, and connect with others
              in one place.
            </strong>
          </p>
        </div>
        <div className="col s12 m6 center" id="visionImg"></div>
      </div>
    </div>
    // </div>
  );
